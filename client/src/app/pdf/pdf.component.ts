     ...
     // console.log(ui.draggable[0].innerText)
        if (!ui.draggable.hasClass('canvas-element')) {
          ...
          if ($.trim(ui.draggable[0].innerText) == 'Initial') {
            canvasElement.append('<div class="removediv" style="border-radius: 5px 5px 5px 5px;-moz-border-radius: 5px 5px 5px 5px;-webkit-border-radius: 5px 5px 5px 5px;border: 3px solid black;margin-left: 3px;min-width: 280px;width: 50px;height: 45px; padding: 0 10px;z-index:999;position:absolute"><div style="word-wrap: break-word; text-align: left; font-family: Cursive, Sans-Serif; font-size: 24px; font-weight: 400; font-style: italic; color: rgb(20, 83, 148);"><div id="signtypeval5" style="height: 35px; width: auto; ">' + userinitials + '</div></div></div>');
           $('.removediv').prev('div.form-group').remove();
            // $('.canvas-element .form-group').remove();
          } else if ($.trim(ui.draggable[0].innerText) == 'Name') {
            // tslint:disable-next-line:max-line-length
            canvasElement.append('<div class="removediv" style="border-radius: 5px 5px 5px 5px;-moz-border-radius: 5px 5px 5px 5px;-webkit-border-radius: 5px 5px 5px 5px;border: 3px solid black;margin-left: 3px;min-width: 280px;width: 200px;height: 45px; padding: 0 10px"><div style="word-wrap: break-word; text-align: left; font-family: Cursive, Sans-Serif; font-size: 24px; font-weight: 400; font-style: italic; color: rgb(20, 83, 148);"><div id="signtypeval5" style="height: 35px; width: auto; ">' + username + '</div></div></div>');
            $('.removediv').prev('div.form-group').remove();
          } else if ($.trim(ui.draggable[0].innerText) == 'Email') {
            // tslint:disable-next-line:max-line-length
            canvasElement.append('<div  class="removediv" style="border-radius: 5px 5px 5px 5px;-moz-border-radius: 5px 5px 5px 5px;-webkit-border-radius: 5px 5px 5px 5px;border: 3px solid black;margin-left: 3px;min-width: 280px;width: 500px;height: 45px; padding: 0 10px;"><div style="word-wrap: break-word; text-align: left; font-family: Cursive, Sans-Serif; font-size: 24px; font-weight: 400; font-style: italic; color: rgb(20, 83, 148);"><div id="signtypeval5" style="height: 35px; width: auto; ">' + useremail + '</div></div></div>');
            $('.removediv').prev('div.form-group').remove();
          } else if ($.trim(ui.draggable[0].innerText) == 'Date') {
            // tslint:disable-next-line:max-line-length
            canvasElement.append('<div class="removediv" style="border-radius: 5px 5px 5px 5px;-moz-border-radius: 5px 5px 5px 5px;-webkit-border-radius: 5px 5px 5px 5px;border: 3px solid black;margin-left: 3px;min-width: 280px;width: 300px;height: 45px; padding: 0 10px; "><div style="word-wrap: break-word; text-align: left; font-family: Cursive, Sans-Serif; font-size: 24px; font-weight: 400; font-style: italic; color: rgb(20, 83, 148);"><div id="signtypeval5" style="height: 35px; width: auto; ">' + todaydate + ' </div></div></div>');
            $('.removediv').prev('div.form-group').remove();
